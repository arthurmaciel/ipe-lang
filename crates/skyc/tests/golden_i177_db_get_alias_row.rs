...
fn i177_alias_row_skyc_bounds_fn_not_struct() {
    assert_skyc_bounds_fn_not_struct("i177_db_get_alias_row");
}

#[test]
fn i177_alias_row_cargo_builds_and_runs() {
    assert_cargo_builds_and_runs("i177_db_get_alias_row");
}

#[test]
fn i177_alias_chain_row_skyc_bounds_fn_not_struct() {
    assert_skyc_bounds_fn_not_struct("i177_db_get_alias_chain_row");
}

#[test]
fn i177_alias_chain_row_cargo_builds_and_runs() {
    assert_cargo_builds_and_runs("i177_db_get_alias_chain_row");
}

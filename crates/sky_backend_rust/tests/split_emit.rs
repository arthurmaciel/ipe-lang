...
fn enum_def(name: sky_intern::Symbol, variant: sky_intern::Symbol, home: ModPath) -> EnumDef {
    EnumDef {
        name,
        home,
        type_params: vec![],
...
const fn int_func(id: u32, name: sky_intern::Symbol, home: ModPath) -> Func {
    Func {
...
fn emit_spine_holds_program_wide_content_not_module_items() -> DResult<()> {
    ...
    assert!(
        spine.contains("pub use sky_runtime::error::SkyError;"),

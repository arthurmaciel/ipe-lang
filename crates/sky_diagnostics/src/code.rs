...
pub fn title(c: Code) -> &'static str {
    match c {
        ...
        SKY_L0122 => "app Msg is not admissible for this app shape",
...
mod tests {
    ...
    const ALL: &[Code] = &[
        ...
        SKY_L0119, SKY_L0120, SKY_L0121, SKY_L0122, SKY_L0200, SKY_I0001, SKY_I0010, SKY_I0011, SKY_I0100, SKY_I0101,
        SKY_I0102, SKY_I0103, SKY_I0200, SKY_I0201, SKY_I0202, SKY_I0203,
    ];

    #[test]
    fn taxonomy_has_eighty_one_codes() {

...
pub fn title(c: Code) -> &'static str {
    match c {
        ...
        SKY_L0125 => "non-Clone capture in a closure is not yet supported",
...
mod tests {
    ...
    const ALL: &[Code] = &[
        ...
        SKY_L0119, SKY_L0120, SKY_L0121, SKY_L0122, SKY_L0123, SKY_L0124, SKY_L0125, SKY_L0200, SKY_I0001, SKY_I0010,

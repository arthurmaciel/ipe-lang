...
impl SkyStringify for MainSqlValue {
    fn sky_show(&self) -> String {
        match self {
            MainSqlValue::SqlString(p0) => format!("SqlString {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlInt(p0) => format!("SqlInt {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlFloat(p0) => format!("SqlFloat {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlBool(p0) => format!("SqlBool {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlBytes(p0) => format!("SqlBytes {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlTime(p0) => format!("SqlTime {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlDecimal(p0) => format!("SqlDecimal {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlMoney(p0) => format!("SqlMoney {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainSqlValue::SqlNull(p0) => format!("SqlNull {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
        }
    }
}
#[derive(Clone, Debug, PartialEq)]
...
impl SkyStringify for MainSqlField {
    fn sky_show(&self) -> String {
        match self {
            MainSqlField::SetField(p0) => format!("SetField {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
...
impl From<MainSqlValue> for sky_runtime::db::SqlParam {

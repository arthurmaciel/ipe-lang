...
pub fn main_or_else(o: MainOpt<i64>, d: i64) -> i64 {
...
pub fn main_pick(o: MainOpt<bool>) -> bool {
    let _ipe_recursion_guard = crate::recursion_guard();
    match o {
        MainOpt::Som(b) => b,
        MainOpt::Non => (0i64 == 1i64),
    }
}
pub fn ipe_main() -> IpeTask<()> {
    let _ipe_recursion_guard = crate::recursion_guard();
    ({
        let n = crate::main_or_else(MainOpt::Som(41i64), 0i64);
        ({
            let flag = crate::main_pick(MainOpt::Som((1i64 == 1i64)));

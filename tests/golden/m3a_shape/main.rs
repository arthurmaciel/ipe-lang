...
impl SkyStringify for MainShape {
    fn sky_show(&self) -> String {
        match self {
            MainShape::Circle(p0) => format!("Circle {}", (&sky_runtime::stringify::Wrap(p0)).dispatch()),
            MainShape::Rect(p0, p1) => format!("Rect {} {}", (&sky_runtime::stringify::Wrap(p0)).dispatch(), (&sky_runtime::stringify::Wrap(p1)).dispatch()),
        }
    }
}

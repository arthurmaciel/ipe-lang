...
pub fn main_first_or(d: i64, xs: Vec<i64>) -> i64 {
    d
}
pub fn sky_main() -> SkyTask<()> {
    log_println(string_from_int(main_first_or(7, sky_runtime::list::sky_list_cons(1, sky_runtime::list::sky_list_cons(2, vec![3, 4, 5])))))
}

# Ipê→Rust Backend Parity Matrix
...
| FFI generator port (`src/Ipê/Build/Rust/Ffi*.hs`) | 0% — not started |
...
| Module | Lines |
|--------|-------|
| `src/Ipê/Build/Rust/Ffi.hs` | 1616 |
| `src/Ipê/Build/Rust/FfiInstance.hs` | 952 |
| `src/Ipê/Build/Rust/FfiCall.hs` | 820 |
| `src/Ipê/Build/FfiGen.hs` | 2093 |
| **Total** | **5481** |

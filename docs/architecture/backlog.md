...
- **inference cluster (ex00/ex12/ex37) — proved to be TWO root causes, not one** (Opus guardian, 2026-07-06):
  ...
  - **cheap independent win:** give `sky_types::solve::Constraint` a **home-module discriminant** so diagnostics point at the real file (byte-offset spans currently resolve against whichever merged file they land in — the cause of every mis-attribution above). Related: #35, #56, #66.

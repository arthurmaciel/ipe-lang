...
- Name: geo-clipboard.spec.mjs >> clipboard: write then read round-trip renders the copied text
- Location: geo-clipboard.spec.mjs:125:1
...
Locator: getByText(/location: 48\.\d+/)
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText(/location: 48\.\d+/) with timeout 5000ms
  - waiting for getByText(/location: 48\.\d+/)

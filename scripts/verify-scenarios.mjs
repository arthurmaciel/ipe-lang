...
// on `baseUrl`, so it applies unchanged to skyc-emitted Rust binaries AND
...
export const scenarios = {
    ...
    async 'live-counter'(page, opts) {
        ...
        // event-emission pipeline is intact end-to-end. Pre-v0.13.2 Std.Ui
    ...
    async skyvote(page, { baseUrl }) {
        ...
        await fillOrThrow(page, 'description', 'Auto-generated by web-verify.mjs to exercise full Sky.Live CRUD path.', 200);

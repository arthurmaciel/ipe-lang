...
/// (its content is project-specific: the `sky.toml` `[wasm] publicEnv`
...
/// backing, generated from `allowlist` (`sky.toml`'s `[wasm] publicEnv`,
...
fn render_env_public_rs(allowlist: &[String]) -> String {
    ...
    format!(
        "// GENERATED by Sky compiler — do not edit ([wasm] publicEnv allowlist)\n\
         //\n\
         // `Ipe.Env.public \"KEY\"` resolves ONLY for a name on this project's\n\
         // `sky.toml` `[wasm] publicEnv` allowlist; every other key returns\n\

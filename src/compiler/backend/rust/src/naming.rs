...
pub const fn kernel_name(k: KernelFn) -> &'static str {
    match k {
        ...
        KernelFn::DsnParse => "dsn_parse",
        KernelFn::DsnBuild => "dsn_build",
        KernelFn::DsnDriverTag => "dsn_driver",
        KernelFn::DsnHost => "dsn_host",
        KernelFn::DsnPort => "dsn_port",
        KernelFn::DsnDatabase => "dsn_database",
        KernelFn::DsnUser => "dsn_user",
        KernelFn::DsnTlsTag => "dsn_tls",
        KernelFn::DsnRedacted => "dsn_redacted",
        KernelFn::DbConnOpen => "db_conn_open",
        KernelFn::DbConnClose => "db_conn_close",
        KernelFn::DbConnUnsafeOpen => "db_conn_unsafe_open",
        KernelFn::DbConnUnsafeExecRawOn => "db_conn_unsafe_exec_raw_on",

...
//!   module (`crates/sky_lower/src/lower.rs`'s `Module.entry` assignment). A
...
//! [`sky_ir::ir::Expr`] or [`sky_ir::ir::Pat`] grows a new case).
...
use sky_ir::{Arm, Callee, Expr, Func, FuncId, ModPath, Pat, Program};

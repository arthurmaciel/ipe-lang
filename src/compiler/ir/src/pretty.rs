...
const fn kernel_name(kernel: KernelFn) -> &'static str {
    match kernel {
        ...
        KernelFn::DbGetString => "Db.Unsafe.unsafeGetString",
        KernelFn::DbGetInt => "Db.Unsafe.unsafeGetInt",
        KernelFn::DbGetBool => "Db.Unsafe.unsafeGetBool",
        KernelFn::DbGetField => "Db.Unsafe.unsafeGetField",
        ...
        KernelFn::SqlUnsafeFragment => "Db.Unsafe.unsafeFragment",
        ...
        KernelFn::UiNode => "Ui.node",
        KernelFn::UiTaggedNode => "Ui.taggedNode",
        ...
        KernelFn::UiTransitionRaw => "Ui.transition",
        KernelFn::UiGridTracksRaw => "Ui.gridTracks",
        KernelFn::UiAnimateRaw => "Ui.animate",
        ...
        KernelFn::UiDescNone => "Ui.descNone",
        KernelFn::UiDescParagraph => "Ui.descParagraph",

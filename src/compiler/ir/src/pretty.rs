...
const fn kernel_name(kernel: KernelFn) -> &'static str {
    match kernel {
        ...
        KernelFn::DbQuery => "Db.unsafeQuery",
        KernelFn::DbQueryDecode => "Db.queryDecode",
        KernelFn::DbGetString => "Db.unsafeGetString",
        KernelFn::DbGetInt => "Db.unsafeGetInt",
        KernelFn::DbGetBool => "Db.unsafeGetBool",
        KernelFn::DbGetField => "Db.unsafeGetField",

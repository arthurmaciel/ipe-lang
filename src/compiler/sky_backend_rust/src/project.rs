...
/// `src/runtime/rust/src/sky_runtime/config.rs` verbatim, keeping the
...
const RUNTIME_CONFIG_RS_DB_SQLITE: &str =
    include_str!("../../../../src/runtime/rust/src/sky_runtime/config.rs");
...
const RUNTIME_CONFIG_RS_DB_POSTGRES: &str =
    include_str!("../../../../src/runtime/rust/src/sky_runtime/config_postgres.rs");

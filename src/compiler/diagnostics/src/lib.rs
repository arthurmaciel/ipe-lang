...
pub use code::{
    ALL_CODES, Code, IPE_I0001, IPE_I0010, IPE_I0011, IPE_I0100, IPE_I0101, IPE_I0102, IPE_I0103,
    ...
    IPE_L0121, IPE_L0122, IPE_L0123, IPE_L0124, IPE_L0125, IPE_L0126, IPE_L0127, IPE_L0200,
    ...
    IPE_T0017, ISSUE_TRACKER_URL, Severity, explain_page, title,
};
pub use diagnostic::{
